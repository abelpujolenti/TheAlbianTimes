...
namespace Workspace.Layout.Pieces
{
    public class PieceData
    {
        ...
        public static readonly Color[] newsTypeColors = { new Color32(230, 76, 166, 255), new Color32(76, 137, 230, 255), new Color32(229, 177, 75, 255),
            ...
            new Color32(131, 153, 178, 255), new Color32(171, 230, 71, 255), new Color32(71, 202, 230, 255), new Color(.9f, .9f, .9f, 1f), Color.gray, Color.gray, Color.gray, Color.gray};
        ...
        public static readonly string[] newsTypeName = { "Politics", "Opinion", "Entertainment", "Diplomacy", "Economics", "Military", "Cultural", "Technology", "Labor", "Ideology", "Information" };
